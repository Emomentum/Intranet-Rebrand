      ...
      for (i = 0; i < data.prefixes.length; i++) {
        ...
        results.push({'data': display_name(prefix),
					 ...
					 // console.log(album_name);                	
								$.ajax({
   										 type:     "GET",
   										 url:      "https://www.googleapis.com/storage/v1/b/emomentum_products_partnership/o?delimiter=&prefix="+album_name+"&key=AIzaSyBc2oN4JLbO8XD3RG3Ey7aFzYl_uXYQgVQ",
   										 dataType: "json",
   										 success: function(data){
       									   ...
       									   if(noofitems == 1){
       									   	...
       									   	for(var i= 1;i<=noofitems;i++){
       									   		...
       									   		document_list.innerHTML = document_list.innerHTML + '<li class="list-group-item"><a target = "_blank" style = "color:#000;padding:0px;"href = "https://docs.google.com/gview?url=https://storage.googleapis.com/emomentum_products_partnership/'+folderdata[0].name+document_name+'&embedded=true">'+document_name+'</a></li>';
       									   	}
