   										 ...
   										 success: function(data){
       									   ...
       									   if(noofitems == 1){
       									   	...
       									   	for(var i= 1;i<=noofitems;i++){
       									   		...
       									   		document_list.innerHTML = document_list.innerHTML + '<li class="list-group-item"><a style = "color:#000;padding:0px;"href = "https://storage.googleapis.com/emomentum_development/'+folderdata[0].name+document_name+'">'+document_name+'</a></li>';
       									   	}
