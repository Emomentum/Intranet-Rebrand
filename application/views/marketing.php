...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket6.config.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket6.js"></script>
...
<div class="row content-department">
  ...
  <ol>
      <li>LEADS GENERATED PIPELINE $248,000,000</li>
      <li>CUSTOMER ACQUISITION 60 (FULL YEAR)</li>
      <li>REVENUE FROM MARKETING ACTIVITIES $ 560,000</li>
  </ol>
   </div>
