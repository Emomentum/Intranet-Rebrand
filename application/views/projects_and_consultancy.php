...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket9.config.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket9.js"></script>
...
<div class="row content-department">
  ...
  <ol>
      <li>PROJECTS PER A YEAR 2</li>
      <li>12 TENDERS A YEAR</li>
  </ol>
   </div>
