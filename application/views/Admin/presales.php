...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/metabucket7.config.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/metabucket7.js"></script>
</head>
<body>
    <div id="wrapper">
...
<div align="left"    width="auto" style="margin-top: 20px;margin-right:20px">
 ...
 <iframe src="http://25.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
</div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
		 ...
		 <iframe src="http://36.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
    ...
    <div class="modal-dialog">
		...
		<div class="row">
		 ...
		 <iframe src="http://71.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
	  ...
	  <div class="col-lg-11  service" id="service1" style="padding-left:0px">
		<div>
    			
    			<div style ="padding: 36px 31px 31px 0px;;text-align: justify;">
