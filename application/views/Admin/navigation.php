                ...
                <div class="sidebar-nav navbar-collapse">
					...
					$useremail =  $this->session->userdata('email');
						...
						<?php
						   ...
						   if ($useremail == 'nicola.mutungi@emomentum-interactive.com'){
					   ?>
					    <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
					...
					<?php
			           ...
			           if ($useremail == 'sylvin.wangui@emomentum-interactive.com'){ 
					   ?>
                            <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
...
?>						
				<li>
					    ...
					    if ($useremail ==  'grace.mureithi@emomentum-interactive.com'){ 
?>	
                               <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
					    ...
					    if ($useremail ==  'andrew.mbuthia@emomentum-interactive.com'){ 
?>	
                                 <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
						...
						<?php
						 ...
						 if ($useremail ==  'jane.wawira@emomentum-interactive.com'){ 
?>	
                                 <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
						...
						if ($useremail ==  'kevin.kabuye@emomentum-interactive.com'){ 
?>	
                                 <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
						...
						<?php
						 ...
						 if ($useremail ==  'george.kangethe@emomentum-interactive.com'){ 
?>	
                                 <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
						...
						<?php
						 ...
						 if ($useremail ==  'joan.muriuki@emomentum-interactive.com'){ 
?>	
                                 <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
						...
						<?php
						 ...
						 if ($useremail ==  'nyambura.ndungu@emomentum-interactive.com'){ 
?>	
                                 <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Departments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
					    ...
					    if
                               ($useremail ==  'test@emomentum-interactive.com' || 'kingsley.amaitsa@emomentum-interactive.com' || 'grace.mureithi@emomentum-interactive.com' || 'bryan.murithi@emomentum-interactive.com' || 'david.odhiambo@emomentum-interactive.com'){
