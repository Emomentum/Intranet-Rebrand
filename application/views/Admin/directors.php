...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/metabucket3.config.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/metabucket3.js"></script>
</head>
<body>
    <div id="wrapper">
...
<!-- end of edit class/#modal -->
      ...
      <!-- Modal content-->
       <div class="modal-content">
        ...
        <div class="modal-body">
		 ...
		 <iframe src="http://21.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
		 ...
		 <iframe src="http://32.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
    ...
    <div class="modal-dialog">
		...
		<div class="row">
		 ...
		 <iframe src="http://74.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
