...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/metabucket8.config.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/metabucket8.js"></script>
</head>
<body>
    <div id="wrapper">
...
<div align="left"    width="auto" style="margin-top: 20px;margin-right:20px">
 ...
 <iframe src="http://26.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-body">
		 ...
		 <iframe src="http://37.sharp-effort-99409.appspot.com" style="zoom:0.60" frameborder="0" height="250" width="99.6%"></iframe>
