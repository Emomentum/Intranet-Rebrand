...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket11.config.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket11.js"></script>
...
<div class="row content-department">
  ...
  <ol>
      <li>NEW BUSINESS SALES $1,468,000</li>
      <li>EXISTING BUSINESS RENEWAL 100%</li>
  </ol>
   </div>
