...
<body>
	<div id="container">
		...
		<?php 
				echo form_open('check_credentials');
			...
			<div class="input_text_01">
				<?php
				$attributes = array('type'=>'text','id'=>'username','name'=>'username','placeholder'=>'Firstname.Lastname');
			...
			<div class="input_text_02">
				<?php
				$attributes = array('type'=>'password','id'=>'password','name'=>'password','placeholder'=>'Password');
				echo form_input($attributes);
				?>
		...
		<div id="sign_tab">
			<div id="log_in">
				...
				<div id="sign_bnt">
					<?php
				$attributes = array('value' =>'Sign In','class'=>'btn btn-primary btn-large btn-block');
				echo form_submit($attributes);
				?>
				</div>
			</div>
			<div id="nilisahau"><?php echo anchor('login/forget','Forgot/Change Password')?></div>
		</div>
		 <?php echo form_close();?>    
	</div>
</body>
