...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket12.config.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>assets2/js/metabucket12.js"></script>
