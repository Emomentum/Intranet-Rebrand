    ...
    if (data.prefixes !== undefined) {
      for (i = 0; i < data.prefixes.length; i++) {
        ...
        results.push({'data': display_name(prefix),
					  ...
					  album.innerHTML = album.innerHTML + "<div style = 'float:left;width:100px;padding:20px;margin:0px 20px 0px 0px;text-align:center;'><a href = 'document_finance/"+album_name+"'><img src = 'http://emomentum_extension.storage.googleapis.com/folder.png' width = '80'/>"+album_name+"</div>";
